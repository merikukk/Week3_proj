...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/parcel-bundler/lib/utils/localRequire.js":[function(require,module,exports) {
"use strict";
...
function _localRequire() {
  _localRequire = (0, _asyncToGenerator2.default)(function (name, path) {
    var triedInstall = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    return /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _yield$localResolve, _yield$localResolve2, resolved;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            _yield$localResolve = _context.sent;
...
function _localResolve() {
  _localResolve = (0, _asyncToGenerator2.default)(function (name, path) {
    var triedInstall = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    return /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var basedir, key, resolved, packageName;
...
var _localRequire = require("parcel-bundler/lib/utils/localRequire");
require("./styles.css");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
  ...
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          link = "https://statfin.stat.fi/PxWeb/sq/4e244893-7761-4c4f-8e55-7a8d41d86eff";
          _context.next = 4;
          return fetch(link);
        case 4:
          datas = _context.sent;
...
function fetchData(datas) {
  var nodeList = document.querySelectorAll(datas.dataset.dimension.Alue.category.label);
  for (var i = 0; i < nodeList.length; i++) {
    var textnode = document.createTextNode(nodeList(i));
...
getData();
},{"parcel-bundler/lib/utils/localRequire":"node_modules/parcel-bundler/lib/utils/localRequire.js","./styles.css":"src/styles.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36245" + '/');
